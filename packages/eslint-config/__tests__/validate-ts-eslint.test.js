...
describe('validate ts configs', () => {
  it('validate ts', async () => {
    ...
    const reports2 = await cli.lintFiles([filePath2, filePath3]);
    assert.ok(sumBy(reports2, 'errorCount') !== 0 || sumBy(reports2, 'warnCount') !== 0);
  });

  it('validate ts vue', async () => {
  ...
  it('validate essential ts react', async () => {
  ...
  it('validate essential ts vue', async () => {
